      ...
      <div className="max-w-7xl">
          ...
          <div className="portfolio-stack-block">
            <div className="relative rounded-xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                <p className="type-label text-paper-muted mb-2">SIMPLY SEFER</p>
                ...
                <p className="type-body-lg text-paper/80 max-w-xl">
        ...
        <FadeIn delay={200}>
          <div className="flex gap-4 overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-3 portfolio-stack-block scrollbar-hide">
            <article className="minimal-card flex-shrink-0 w-72 md:w-auto">
            ...
            <article className="minimal-card-emphasis flex-shrink-0 w-72 md:w-auto">
            ...
            <article className="minimal-card flex-shrink-0 w-72 md:w-auto">
              ...
              <p className="text-paper-muted leading-relaxed">
                Connect with collectors, scholars, and sellers across the global Jewish community.
              </p>
            </article>
          </div>
        </FadeIn>
